...
!function(a) {
    ...
    b.prototype.update = function() {
        ...
        {
          tick = 0;
          //this.g.strokeStyle = getRandomColor(this.g.strokeStyle, 1);
          this.g.strokeStyle = incrColor();
        }
...
function getRandomColor(color, step){
  ...
  var start = 0x000000,
    ...
    function incrColor()
    {
       ...
       if(start== end){start = 0x000000};
       temp = (start).toString(18);
             if(temp.length < 8){

                 temp = "59ff00".substring(0, 8-temp.length)+temp;
             }
                       start += 1000;
